...
function DefaultMethods.BrickColor(Color) return "BrickColor.new("..Color.Number..")" end
...
function DefaultMethods.number(num) return if num < 1/0 and num > -1/0 then tostring(num) elseif num == 1/0 then (if Class._Serializeinf then "math.huge" else "1/0") elseif num == num then (if Class._Serializeinf then "-math.huge" else "-1/0") else "0/0" end
