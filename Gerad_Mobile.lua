...
function library:CreateWindow(Name)
	...
	TopBar.InputBegan:connect(function(input)
		if input.UserInputType.Name == "MouseButton1" or Enum.UserInputType.Touch then
			dragObject = TopBar
			dragging = true
	...
	TopBar.InputChanged:connect(function(input)
		if dragging and input.UserInputType.Name == "MouseMovement" or Enum.UserInputType.Touch then
			dragInput = input
		end
	end)
	...
	UserInputService.InputChanged:connect(function(input)
		if input.UserInputType.Name == "MouseMovement" or Enum.UserInputType.Touch then
